...
export default function ProfileHeader({Profile}:{Profile:IProfile}){
    return(
        <Link href={`/platform/profile/${Profile?.id}`} className="rounded-xl border-2 border-2 bg-white border-opacity-20 p-6 flex gap-4 hover:shadow-xl duration-300 hover:scale-105 active:scale-95 flex-col relative  shadow-xl ">
