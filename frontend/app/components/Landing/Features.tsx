...
export default function Features(){
    return(
        <div className="flex w-full min-h-screen p-24 max-md:p-4  ">
            <div className=" flex flex-col gap-16">

                <div className="flex flex-col gap-8 text-center">
                        <h1 className="text-5xl max-md:text-4xl font-bold">Discover the Right Partner Faster
                        </h1>
                        <p className="text-slate-500 w-[50%] max-md:w-full self-center text-lg">Stop searching endlessly. Our AI-driven platform matches you with developers who align with your goals, expertise, and vision.</p>   
                    </div>
                <div className="flex flex-col gap-32 max-md:grid-cols-4 grid-cols-8 bg-gradient-to-b max-md:p-0  p-12 rounded-xl">
