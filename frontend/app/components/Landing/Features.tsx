        ...
        <div className="flex w-full min-h-screen p-24  ">
            <div className=" flex flex-col gap-16">
                <div className="flex flex-col gap-8 text-center">
                        ...
                        <p className="text-slate-500 w-[50%] self-center text-lg">Turn your vision into reality by finding your ideal technical co-founder or partner through our AI-powered platform.</p>   
                    </div>
                <div className="grid gap-8 grid-cols-8 bg-gradient-to-b  p-12 rounded-xl">
                    ...
                    <Feature className="  col-span-4" image="Explore.png" icon={<FaDatabase className=" shadow-md p-3 rounded-xl" size={50}></FaDatabase>} feature="Comprehensive Profile Database" desc="Explore a curated database of skilled professionals ready to collaborate. Tailored filters ensure you see only the most relevant matches."></Feature>
                    ...
                    <Feature className="  col-span-3" image="Message.png" icon={<FaMessage className="shadow-md p-3 rounded-xl" size={50}/>} feature="Real-Time Messaging" desc="Start conversations instantly. Build connections faster with real-time direct messaging."></Feature>
